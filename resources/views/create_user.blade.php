                ...
                <div class="-body">
                    <form method="POST" action="{{ route('register_utilizador') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Nome da Instituição</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">Email da Instituição</label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">Adicionar Papel</label>

                            <div class="col-md-6">
                                <label for="validationCustom04"></label>
                           
                            <select class="custom-select" id="validationCustom04" name="papal_id" required>
